...
public class GradeDashboardApp extends Application {
    ...
    private HBox createFilterRow() {
        ...
        ComboBox<String> categoricalValueCombo = new ComboBox<>();
    ...
    private void onRenderVisualization() {
        ...
        switch (plotType) {
            ...
            case SCATTER:
                ...
                break;
            case SWARM:
                handleSwarmPlot(datasetDisplay, chosenCourses, gradesData, courseNames);
                break;
            case JOINT:
    ...
    private void handleBarPlot(String datasetDisplay,
        ...
        Map<String, double[]> courseGradesMap = buildCourseGradesMap(chosenCourses, gradesData, courseNames);
    ...
    private Map<String, double[]> buildCourseGradesMap(List<String> chosenCourses,
        ...
        for (String courseName : chosenCourses) {
            ...
            phase2Handler handler = new phase2Handler(gradesData, null, courseColumn);
