...
public class FileDisplayerUpToPart3 {
    ...
    public static void main(String[] args) {
        ...
        coursesThatSeparateTop(GraduateGradesArray, CourseNamesArray);
...
STEP3PART2(CurrentGrades);

STEP3PART3(CurrentGrades, StudentInfoArray, 3);
...
STEP3PART4(29, results, best_index, SI, features);
}
...
System.out.println("\n" + SI[studentID][FeatureColumn] + " " + features[best_index] + "\n");
