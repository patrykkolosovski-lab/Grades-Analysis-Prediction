...
public class FileDisplayer {
    ...
    public static void main(String[] args) {
        ...
        //args[0]
        String fileName = "resources/CurrentGrades.csv"; // The name of the file you want to read
        ...
        // test Splitter
        Splitter splitter = new Splitter("Stable");
        //TODO: NOT WORKING
        int[] indexes = splitter.getStudentIndexWithFeature(studentinformationreader.StudentInfoArray);
